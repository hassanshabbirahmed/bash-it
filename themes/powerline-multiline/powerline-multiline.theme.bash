...
LAST_STATUS_GOOD_PROMPT_COLOR=2
...
POWERLINE_LEFT_PROMPT=${POWERLINE_LEFT_PROMPT:="user_info scm cwd"}
POWERLINE_RIGHT_PROMPT=${POWERLINE_RIGHT_PROMPT:="in_vim clock"}
